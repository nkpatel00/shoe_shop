<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="show_product.aspx.cs" Inherits="shoe_shop.show_product" %>
    ...
    <div class="container product-container">
        ...
        <form runat="server">
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                <asp:DataList ID="DataList1" runat="server" RepeatColumns="3" RepeatDirection="Horizontal" CssClass="row" OnItemCommand="DataList1_ItemCommand" OnSelectedIndexChanged="DataList1_SelectedIndexChanged">
                    <ItemTemplate>
                        <div class="col">
                            <div class="product-card p-3">
                                <asp:Image ID="Image1" runat="server" CssClass="product-img" ImageUrl='<%# Eval("Image") %>' />
                                <h5 class="mt-2"><asp:Label ID="Label1" runat="server" Text='<%# Eval("ProductName") %>' CssClass="product-details"></asp:Label></h5>
                                <p class="text-muted">
                                    <strong>Category:</strong> <asp:Label ID="Label2" runat="server" Text='<%# Eval("CategoryId") %>'></asp:Label><br>
                                    <strong>Price:</strong> $<asp:Label ID="Label3" runat="server" Text='<%# Eval("Price") %>'></asp:Label><br>
                                    <strong>Stock:</strong> <asp:Label ID="Label4" runat="server" Text='<%# Eval("Stock") %>'></asp:Label><br>
                        ...
                        <div class="col">
                            <div class="product-card p-3">
                                ...
                                <asp:Image ID="Image1" runat="server" CssClass="product-img" 
                                    ImageUrl='<%# string.IsNullOrEmpty(Eval("Image").ToString()) ? "~/Images/default.jpg" : ResolveUrl(Eval("Image").ToString()) %>' />
