                    ...
                    <nav class="navbar navbar-expand-lg bg-white border-bottom sticky-top shadow">
                        <div class="container-fluid px-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="userprofile.aspx" class="me-3 text-dark"><i class="bi bi-person"></i></a><a href="#"><i class="bi bi-bag text-dark"></i></a>
                            </div>
                        </div>
                    </nav>
...
<asp:Content ID="Content3" runat="server" contentplaceholderid="ContentPlaceHolder2">
                ...
                <div class="banner-container">
                    ...
                    <div class="banner-text">
                        ...
                        <p class="fs-3">
                            Step into Comfort & Style</p>
                        <a href="shop_all.html" class="btn btn-light btn-lg rounded-3">Shop Now</a>
                    </div>
    </div>
    <br>
    <br>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-3">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <a href="rain.html" class="btn btn-dark">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <!-- Product 2 -->
                        <div class="col-md-3">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <a href="snow.html" class="btn btn-dark">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <!-- Product 3 -->
                        <div class="col-md-3">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <a href="weekend.html" class="btn btn-dark">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <!-- Product 4 -->
                        <div class="col-md-3">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body text-center">
                                    <h5 class="card-title">Classic All Weather Shoes</h5>
                                    <a href="shop_all.html" class="btn btn-dark">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-3 mb-4">
                                    <img src="Logo1.png" height="50px" width="100px" alt="Amber logo" class="mb-3">
                                    <p>
                                        Socially and environmentally progressive outdoor footwear</p>
                                ...
                                <div class="col-md-3 mb-4">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li><a href="#">The Anyday Rain Boot™</a></li>
                                        <li><a href="#">The Modern Winter Boot™</a></li>
                                        <li><a href="#">The Winter Weekend Boot Z™</a></li>
                                        <li><a href="#">The Terrus™ Clog</a></li>
                                        <li><a href="#">Accessories</a></li>
                                        <li><a href="#">Amber™ Gift Card</a></li>
                                    </ul>
                                </div>
                                <div class="col-md-3 mb-4">
                                    <h5>Help</h5>
