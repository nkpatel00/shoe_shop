<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Weekend.aspx.cs" Inherits="shoe_shop.Weekend" %>
...
<body>
    ...
    <div class="container product-container">
        <h2 class="text-center mb-4">Weekend - Product List</h2>
        <p class="text-center mb-4">&nbsp;</p>

        <form runat="server">
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                <asp:DataList ID="DataList1" runat="server" RepeatColumns="3" RepeatDirection="Horizontal" CssClass="auto-style1"
                    OnItemCommand="DataList1_ItemCommand" OnSelectedIndexChanged="DataList1_SelectedIndexChanged" Width="1535px">
                    <ItemTemplate>
                        <div class="col">
